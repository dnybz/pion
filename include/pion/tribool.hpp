...
// http://www.pion.org/LICENSE_1_0.txt)
...
namespace pion {  namespace logic {
 ...
 * macro \c STATICLIB_HTTPSERVER_TRIBOOL_THIRD_STATE.
 *
...
}  } // end namespace staticlib::httpserver::logic

// Pull tribool and indeterminate into namespace "pion"
namespace pion { 
  using logic::tribool;
 ...
 *
 * Example:
 *   STATICLIB_HTTPSERVER_TRIBOOL_THIRD_STATE(true_or_false)
 *
 ...
 *   }
 */
#define PION_TRIBOOL_THIRD_STATE(Name)                                 \
inline bool                                                             \
Name(pion::logic::tribool x,                                           \
